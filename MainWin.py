...
class MainWin(QtWidgets.QMainWindow):
    ...
    def gauss(self,xg,yg,xgf,ygf,reflevel,invert):
        try:
    ...
    def voigt(self,xg,yg,xgf,ygf,reflevel,invert):
        try:
            ...
            if invert == False:
                g = fit_g(g_init, xg, yg)
                if self.script == False:
                    self.ax.plot(xgf, g(xgf), label='%s'%("Voigt"))#*np.polyval(linecoeff,xgf), label='%s'%(func))
                amp=g.amplitude_L*u.flx

            elif invert == True:
                g = fit_g(g_init, xg, reflevel-yg)
                if self.script == False:
                    self.ax.plot(xgf, (reflevel-g(xgf)), label='%s'%("Voigt"))#*np.polyval(linecoeff,xgf), label='%s'%(func))
                amp=reflevel*u.flx-g.amplitude_L*u.flx
            t=self.filedate()
            ...
            print("Exception in MainWin.voigt")

    def lorentz(self,xg,yg,xgf,ygf,reflevel,invert):
        try:
            ...
            if invert == False:
                g = fit_g(g_init, xg, yg)
                if self.script == False:
                    self.ax.plot(xgf, g(xgf), label='%s'%("Lorentz"))#*np.polyval(linecoeff,xgf), label='%s'%(func))
                amp=g.amplitude*u.flx
            elif invert == True:
                g = fit_g(g_init, xg, reflevel-yg)
                if self.script == False:
                    self.ax.plot(xgf, (reflevel-g(xgf)), label='%s'%("Lorentz"))#*np.polyval(linecoeff,xgf), label='%s'%(func))
                amp=reflevel*u.flx-g.amplitude*u.flx
            ...
            print("Exception in MainWin.lorentz")
    ...
    def fit(self,func="gauss"):
        ...
        try:
            if func=="gauss":
                ...
                self.voigt(xg,yg,xgf,ygf,reflevel,invert)
            elif func=="lorentz":
                self.lorentz(xg,yg,xgf,ygf,reflevel,invert)
            else:
                pass
            if self.legend == True:
                self.ax.legend()
        ...
        if func == False:
            ...
            for f in self.database:
                ...
                if func == "norm":
                    ...
                    self.Spectra.smooth(func="boxcar")
                elif func == "gsmooth":
                    self.Spectra.smooth(func="gaussian")
                elif func == "savepng":
                    self.saveImage()
                elif func == "savefits":
                    self.savefits()
